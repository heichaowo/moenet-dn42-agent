...
PostUp = ip -6 addr add fe80::igp:{{ node_id }}/64 dev %i || true
PostDown = ip -6 addr del fe80::igp:{{ node_id }}/64 dev %i || true
...
{% endif %}
AllowedIPs = fe80::igp:{{ peer_node_id }}/128, {{ peer_loopback }}/128
